#!/usr/bin/env python3
"""
Upload all Beginner DeFi Concepts GitBook images to Google Cloud Storage.
Mirrors the folder structure: lessons/lesson_XX/
"""
...
BUCKET_NAME = os.getenv('GCS_BUCKET_NAME', 'beginner-defi-concepts-gitbook-images')
PROJECT_ID = 'defi-university'

def upload_images():
    """Upload all images from content/images/lessons/ to GCS"""
    ...
    # Find all images in content/images/lessons/
    script_dir = Path(__file__).parent
    gitbook_dir = script_dir.parent
    images_dir = gitbook_dir / 'content' / 'images' / 'lessons'
